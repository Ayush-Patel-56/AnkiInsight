...
public abstract class Hilt_DeckSelectorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeckSelectorFragment() {
    super();
  }

  Hilt_DeckSelectorFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeckSelectorFragment_GeneratedInjector) this.generatedComponent()).injectDeckSelectorFragment(UnsafeCasts.<DeckSelectorFragment>unsafeCast(this));
    }
  }
