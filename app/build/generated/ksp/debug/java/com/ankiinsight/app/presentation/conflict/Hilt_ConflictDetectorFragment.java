...
public abstract class Hilt_ConflictDetectorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConflictDetectorFragment() {
    super();
  }

  Hilt_ConflictDetectorFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConflictDetectorFragment_GeneratedInjector) this.generatedComponent()).injectConflictDetectorFragment(UnsafeCasts.<ConflictDetectorFragment>unsafeCast(this));
    }
  }
