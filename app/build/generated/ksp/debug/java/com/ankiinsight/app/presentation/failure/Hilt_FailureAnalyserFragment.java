...
public abstract class Hilt_FailureAnalyserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FailureAnalyserFragment() {
    super();
  }

  Hilt_FailureAnalyserFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FailureAnalyserFragment_GeneratedInjector) this.generatedComponent()).injectFailureAnalyserFragment(UnsafeCasts.<FailureAnalyserFragment>unsafeCast(this));
    }
  }
