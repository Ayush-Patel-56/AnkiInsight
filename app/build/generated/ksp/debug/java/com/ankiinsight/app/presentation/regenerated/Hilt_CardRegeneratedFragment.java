...
public abstract class Hilt_CardRegeneratedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardRegeneratedFragment() {
    super();
  }

  Hilt_CardRegeneratedFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardRegeneratedFragment_GeneratedInjector) this.generatedComponent()).injectCardRegeneratedFragment(UnsafeCasts.<CardRegeneratedFragment>unsafeCast(this));
    }
  }
