...
public abstract class Hilt_ConceptGapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConceptGapFragment() {
    super();
  }

  Hilt_ConceptGapFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConceptGapFragment_GeneratedInjector) this.generatedComponent()).injectConceptGapFragment(UnsafeCasts.<ConceptGapFragment>unsafeCast(this));
    }
  }
